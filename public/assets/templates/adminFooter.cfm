					...
					<div class="modal-body">
							<form id="addCouponForm">
									<div class="form-group">
											...
											<input type="text" class="form-control" id="addCouponCode" name="couponCode" required>
									</div>
									<div class="form-group">
											<label for="discount">Discount Amount:</label>
											<input type="number" class="form-control" id="addDiscount" name="discount" required min="1">
									</div>
									<button type="button" class="btn btn-primary" id="addCouponDB">Add Coupon</button>
							</form>
					</div>
			</div>
	</div>
