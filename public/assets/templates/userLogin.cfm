...
<body class="d-flex flex-column" style="min-height: 100vh;">
    <div class="container my-5">
        ...
        <div class="d-flex justify-content-center">
            ...
            <div class="login-box m-auto mt-5 col-4" style="background-color: #eee; border-radius: 20px; padding: 2rem;">
                <form action="">
                    <input type="text" class="form-control m-2" placeholder="Enter Username">
                    <input type="password" class="form-control m-2" placeholder="Enter Password">
